(function() {
    ...
    FindReservationController.$inject = ['reservationService', '$routeParams'];

    function FindReservationController(reservationService, $routeParams) {
        var findReservationVm = this;

        //findReservationVm.reservationDetails = null;
