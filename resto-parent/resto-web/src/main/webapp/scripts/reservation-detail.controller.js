(function() {
    ...
    ReservationDetailController.$inject = ['reservationService', '$routeParams',  'rootUrl','$location'];

    function ReservationDetailController(reservationService, $routeParams, rootUrl, $location) {
        ...
        reservationDetailVm.deleteReservationDetails = function(reserveId) {
            reservationService
                ...
                .then(function (data) {
                   ...
                   // $location.url('/api/reservations');  //TODO take use back to list page
                }, function (error) {
                    console.log(error);
                    reservationDetailVm.successFlag = "false";
